...
#'
#' @details  The `drosera` dataset is the resident dataset of the
#'   [corrmorant](https://github.com/r-link/corrmorant) package. It contains 150
...
#'   anthocyanin-reduced forms _Drosera venusta_. The measurements were performed
#'   in July 2020 on plants growing on my (R.M. Link's) windowsill in a matter of
#'   a couple of hours with a regular caliper and therefore do not necessarily
...
#'   In particular, if you need a replacement dataset for `iris` for the
...
#'   page](https://github.com/r-link/drosera) in case you decide to use it (and
#'   maybe drop me a line so I can link your project in the repository), but I
